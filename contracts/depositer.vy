...
@external
def initial(_pool: address, _token: address, _base_lp: address):
    """
...
def remove_liquidity_one_coin(_token_amount: uint256, i: int128, _min_amount: uint256) -> uint256:
    ...
    if i < MAX_COIN:
        ...
        self.call_remove_liquidity_one_coin(
...
def calc_withdraw_one_coin(_token_amount: uint256, i: int128) -> uint256:
    ...
    if i < MAX_COIN:
        ...
        return self.call_calc_withdraw_one_coin(base_tokens, i-MAX_COIN)
